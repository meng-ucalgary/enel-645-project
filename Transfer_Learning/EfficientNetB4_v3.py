...
# Purpose
    Transfer Learning with EfficientNetB4 models using pretrained imagenet weights
...
# Model summary:
    ...
    _________________________________________________________________
    avg_pool (GlobalAveragePooli (None, 1792)              0
    _________________________________________________________________
    top_dropout (Dropout)        (None, 1792)              0
    _________________________________________________________________
    prediction (Dense)           (None, 52)                93236
    =================================================================
...
# #############################################################################
model_name_it = 'Outputs/TL_EfficientNetB4_v3_it.h5'
model_name_ft = 'Outputs/TL_EfficientNetB4_v3_ft.h5'
...
# #############################################################################
it_file = open("Outputs/TL_EfficientNetB4_v3_it_history.pkl", "wb")
...
# Saving the model history
# #############################################################################
ft_file = open("Outputs/TL_EfficientNetB4_v3_ft_history.pkl", "wb")
