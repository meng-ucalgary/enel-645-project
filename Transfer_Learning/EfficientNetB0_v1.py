...
# Model summary:
    ...
    _________________________________________________________________
    dense (Dense)                (None, 52)                3261492
    =================================================================
    Total params: 7,311,063
    Trainable params: 3,261,492
...
# #############################################################################
model_name_it = 'Outputs/TL_EfficientNetB0_v1_it.h5'
model_name_ft = 'Outputs/TL_EfficientNetB0_v1_ft.h5'
...
# #############################################################################
it_file = open("Outputs/TL_EfficientNetB0_v1_it_history.pkl", "wb")
...
# Saving the model history
# #############################################################################
ft_file = open("Outputs/TL_EfficientNetB0_v1_ft_history.pkl", "wb")
